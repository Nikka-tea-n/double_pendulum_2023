...
public class Main extends JFrame {
    ...
    public static boolean animationOn; // на паузе ли
    public static boolean unvisible;
    public static boolean ended; // завершена ли анимация (т е можно ли менять положения маятников)
    ...
    public static void main(String[] args) {
        ...
        main.setBounds(100, 50, 2560, 1440);
        Main.ended = true;
